		...
		iconList: [
			{
				...
				value: data['added'],
				icon: { component: IconPlus, props: { size: '1rem', color: colors.affirmative.primary } }
			},
			{
				label: 'Removed',
				color: colors.destructive.primary,
				value: data['removed'],
				icon: { component: IconMinus, props: { size: '1rem', color: colors.destructive.primary } }
			}
		]
	};
}
		...
		iconList: [
			{
				...
				value: data['bugs'],
				icon: { component: IconBug, props: { size: '1rem', color: colors.warning.primary } }
			},
			{
				label: 'Enhancements',
				color: colors.brand.primary,
				value: data['enhancements'],
				icon: { component: IconStar, props: { size: '1rem', color: colors.brand.primary } }
			}
		]
	};
}
